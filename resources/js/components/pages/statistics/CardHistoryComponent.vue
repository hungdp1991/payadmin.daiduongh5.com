    ...
    <div class="container-fluid" v-else>
        <div class="row page-titles">
            <div class="col-md-6 align-self-center">
                <h4 class="text-themecolor font-weight-bolder">Lịch sử nạp thẻ</h4>
            </div>
            <div class="col-md-6 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <button :disabled="cardHistoryList.length === 0 || inExporting || !permissions.exportCardHistory"
                            @click="exportCardHistoryExcel"
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control custom-select"
                                                ...
                                                v-model="cardHistoryItem.gameId"
                                                v-select2="cardHistoryItem.gameId">
                                            <option value="">---</option>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"
                                               v-model="cardHistoryItem.transactionId"/>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Tình trạng</label>
                                        <select class="form-control" v-model="cardHistoryItem.transactionStatus">
                                            <option value="">---</option>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" v-model="cardHistoryItem.username"/>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control custom-select"
                                                style="width: 100%; height:36px;"
                                                v-model="cardHistoryItem.cardType"
                                                v-select2="cardHistoryItem.cardType">
                                            <option value="">---</option>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Serial</label>
                                        <input class="form-control" type="text" v-model="cardHistoryItem.cardSerial"/>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Code</label>
                                        <input class="form-control" type="text" v-model="cardHistoryItem.cardCode"/>
                                    </div>
                                </div>
                            </div>
                        </form>
                        <pagination-component :data="this.pagination" @reloadList="getPaginatedCardHistoryList"
                                ...
                                <div v-else>
                                    <div class="table-responsive m-t-20">
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <tbody>
                                            <tr v-for="historyItem in cardHistoryList"
                                                v-show="cardHistoryList.length > 0">
                                            ...
                                            <tr v-show="cardHistoryList.length == 0">
    ...
    export default {
        ...
        data() {
            return {
                ...
                pagination: {},
                permissions: {
                    exportCardHistory: this.$store.state.authentication.userInfo.role.permissions.includes('ExportCardHistory'),
                },
                allGamesList: [],
                allCardsList: [],
        ...
        watch: {
            'cardHistoryItem.timeRange': function () {
                this.getPaginatedCardHistoryList(1);
            },
            'cardHistoryItem.transactionStatus': function () {
                this.getPaginatedCardHistoryList(1);
            },
            'cardHistoryItem.gameId': function () {
                this.getPaginatedCardHistoryList(1);
            },
            'cardHistoryItem.username': function () {
                this.getPaginatedCardHistoryList(1);
            },
            'cardHistoryItem.transactionId': function () {
                this.getPaginatedCardHistoryList(1);
            },
            'cardHistoryItem.cardType': function () {
                this.getPaginatedCardHistoryList(1);
            },
            'cardHistoryItem.cardSerial': function () {
                this.getPaginatedCardHistoryList(1);
            },
            'cardHistoryItem.cardCode': function () {
                this.getPaginatedCardHistoryList(1);
            },
        },
        mounted() {
        ...
        methods: {
            ...
            changeHistoryItemTimeRange(event) {
                this.cardHistoryItem.timeRange = event.target.value;
            },
             ...
             * @created 2020-02-26 LongTHK
             */
            async getPaginatedCardHistoryList(pageNumber) {
                // get init statistics list
                this.inFetching = true;

                // call api
                await statisticsServices.getPaginatedCardHistoryList(this.cardHistoryItem, pageNumber)
                    .then((response) => {
                        // get response data
                        let responseData = response.data;
                        // set statistics data
                        this.cardHistoryList = responseData.cardHistoryList;
                        // set pagination
             ...
             */
            exportCardHistoryExcel() {
                // set inExporting mode
                this.inExporting = true;

                statisticsServices.exportCardHistoryExcel(this.cardHistoryItem)
                    .then((response) => {
                        ...
                        link.href = url;
                        link.setAttribute('download', 'Lich_su_nap_the.xlsx');
